#!/bin/bash
#SBATCH -J ce-realpha-llama1B
#SBATCH -o logs/ce_realpha_llama1B_%j.out
#SBATCH -e logs/ce_realpha_llama1B_%j.err
#SBATCH -t 4:00:00
#SBATCH -n 1
#SBATCH --gpus=rtx_4090:1
#SBATCH --mem-per-cpu=60000
# =============================================================================
# CE-only: Tokens -> Characters (hf_realpha) — Llama 3.2 1B
...
echo "============================================================"
echo "  CE-only Realpha — Llama 3.2 1B"
...
for ths in $THRESHOLDS; do
    ...
    $RUN \
      ...
      --max-retries 20 \
      --ce-only \
      --output "results/ce_realpha_llama_1B.pkl" \
