#!/bin/bash
#SBATCH -J ce-realpha-phi4
#SBATCH -o logs/ce_realpha_phi4_%j.out
#SBATCH -e logs/ce_realpha_phi4_%j.err
#SBATCH -t 4:00:00
#SBATCH -n 1
#SBATCH --gpus=rtx_4090:2
#SBATCH --mem-per-cpu=60000
# =============================================================================
# CE-only: Tokens -> Characters (hf_realpha) — Phi-4 14B
# Single-symbol scoring (~256x faster, no full distributions).
# Reports cross-entropy, bits/byte, and bytes/sec.
# Requires 2 GPUs (tensor parallelism) for 14B model.
# =============================================================================
...
echo "============================================================"
echo "  CE-only Realpha — Phi-4 14B"
...
for ths in $THRESHOLDS; do
    ...
    $RUN \
      ...
      --max-retries 20 \
      --ce-only \
      --output "results/ce_realpha_phi4.pkl" \
