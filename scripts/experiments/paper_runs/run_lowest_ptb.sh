#!/bin/bash
# =============================================================================
# Lowest 2 thresholds — PTB only (gpt2, llama1B, llama8B)
#
# Usage:
#   CUDA_VISIBLE_DEVICES=1 bash run_lowest_ptb.sh
# =============================================================================
set -euo pipefail
...
EXPERIMENTS=(
    "ptb_gpt2          ptb_ported   gpt2-large                   ptb      --genlm-K 8 --genlm-prune 0.001"
    "ptb_llama1B       ptb_ported   meta-llama/Llama-3.2-1B      ptb      --genlm-K 8 --genlm-prune 0.001"
    "ptb_llama8B       ptb_ported   meta-llama/Llama-3.1-8B      ptb      --genlm-K 8 --genlm-prune 0.001 --max-model-len 4096"
)

echo "============================================================"
echo "  PTB — lowest thresholds (0.000003, 0.000001)"
echo "  $(date)"
echo "============================================================"
