#!/bin/bash
#SBATCH -J realpha-llama8B
#SBATCH -o logs/realpha_llama8B_%j.out
#SBATCH -e logs/realpha_llama8B_%j.err
#SBATCH -t 4:00:00
#SBATCH -n 1
#SBATCH --gpus=rtx_4090:1
#SBATCH --mem-per-cpu=60000
# =============================================================================
# Tokens -> Characters (hf_realpha) — Llama 3.1 8B
#
# Usage:
#   sbatch src/transduced_lm/benchmark/gpu_scripts/realpha_llama8B.sh
#   sbatch src/transduced_lm/benchmark/gpu_scripts/realpha_llama8B.sh --quick
#   TLM_LOCAL=1 bash realpha_llama8B.sh [--quick]  # local run (tlm env)
# =============================================================================
...
for ths in $THRESHOLDS; do
    ...
    $RUN \
      ...
      --max-retries 20 \
      --output "results/realpha_llama_8B.pkl" \
