#!/bin/bash
#SBATCH -J ptb-llama1B
#SBATCH -o logs/ptb_llama1B_%j.out
#SBATCH -e logs/ptb_llama1B_%j.err
#SBATCH -t 4:00:00
#SBATCH -n 1
#SBATCH --gpus=rtx_4090:1
#SBATCH --mem-per-cpu=80000
# =============================================================================
# Tokens -> Words (ptb_ported) — Llama 3.2 1B
#
# Usage:
#   sbatch src/transduced_lm/benchmark/gpu_scripts/ptb_llama1B.sh
#   sbatch src/transduced_lm/benchmark/gpu_scripts/ptb_llama1B.sh --quick
#   TLM_LOCAL=1 bash ptb_llama1B.sh [--quick]    # local run (tlm env)
# =============================================================================
...
for ths in $THRESHOLDS; do
    ...
    $RUN \
      ...
      --max-retries 20 \
      --output "results/ptb_llama_1B.pkl" \
