#!/bin/bash
#SBATCH -J du-realpha-llama1B
#SBATCH -o logs/du_realpha_llama1B_%j.out
#SBATCH -e logs/du_realpha_llama1B_%j.err
#SBATCH -t 48:00:00
#SBATCH -n 1
#SBATCH --gpus=rtx_4090:1
#SBATCH --mem-per-cpu=200000
# =============================================================================
# Drop Universals — hf_realpha + Llama 3.2 1B
# =============================================================================
...
echo "============================================================"
echo "  Drop Universals — hf_realpha + Llama 3.2 1B"
...
$RUN \
  ...
  --output "results/drop_universals_llama_1B_realpha.pkl"
